    ...
    public class Database
    {
        public static void Main(string[] args)
        {
            using (Repository db = new Repository())
            {
                ...
                //Courses and Lessons
                /////////////////////////////
                db.Courses.Add(new Course("Програмування мовою C++", "Курс для студентів 1 курс ФПМІ", muzychuk, Convert.ToDateTime("01.09.2017 08:30"), Convert.ToDateTime("31.12.2017 08:30")));
                db.Courses.Add(new Course("Проектування програмних систем", "Курс проектування програмних систем з використанням ASP .NET Core MVC", muzychuk, Convert.ToDateTime("01.03.2018 08:30"), Convert.ToDateTime("31.05.2018 08:30")));
                db.Courses.Add(new Course("Математичний аналіз", "Річний курс для студентів першого курсу ФПМІ", tarasyuk, Convert.ToDateTime("01.09.2017 08:30"), Convert.ToDateTime("31.12.2017 08:30")));
                db.Courses.Add(new Course("Алгоритми і структури даних", "Початковий курс алгоритмів сортування, пошуку та структур даних(дерева, хештаблиці, розріджені матриці, стек, черга)", litynskyy, Convert.ToDateTime("01.09.2017 08:30"), Convert.ToDateTime("31.12.2017 08:30")));
                db.Courses.Add(new Course("Бази даних та інформаційні системи", "Курс для освоєння роботи з реляційними та нереляційними базами даних, орієнтований на студентів 3 курсу ФПМІ", litynskyy, Convert.ToDateTime("01.05.2018 8:30"), Convert.ToDateTime("31.05.2018 8:30")));
                db.SaveChanges();
