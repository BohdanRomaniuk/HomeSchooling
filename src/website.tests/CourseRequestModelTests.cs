...
namespace website.tests
{
    public class CourseRequestModelTests
    {
        ...
        public void CourseRequestModelTest()
        {
            ...
            CourseRequestModel testobj1 = new CourseRequestModel(1, "text1", "text2", "text3");

            //Act
            CourseRequestModel testobj2 = new CourseRequestModel(field1, field_3, field_4, field_5);
            //Assert
        ...
        {
            //Arrange
            CourseRequestModel testobj = new CourseRequestModel(1, "text", "text", "text");
            int testId = 2;
